...
export default function Portfolio() {
    return (
        <div className='mt-10 '>
            ...
            <div className="item mt-20 h-[90vh]">
                <div className="img w-[90vw] h-[27vh]    overflow-hidden shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px] mx-auto">
                ...
                <div className="details w-[90vw] mx-auto items-center h-[30vh]">
                    ...
                    <div className="tech w-[44vw] mx-auto font-xl gap-x-8 items-center mt-4 h-[10vh] flex flex-row">
                ...
                <div className="code flex flex-row w-[75vw] h-[10vh] mx-auto mt-[10vh] gap-x-14">
            ...
            <div className="item mt-20 h-[90vh]">
                <div className="img w-[90vw] h-[27vh] bg-black    overflow-hidden shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px] mx-auto">
                ...
                <div className="code flex flex-row h-[10vh] w-[75vw] mx-auto mt-[10vh] gap-x-14">
                    <div className='w-[30vw] h-16  rounded-xl flex flex-row items-center'>
            ...
            <div className="item mt-20 h-[90vh] ">
                ...
                <div className="code flex flex-row w-[75vw] mx-auto h-[10vh] mt-[10vh] gap-x-14">
            ...
            <div className="item mt-20 h-[100vh] ">
                <div className="img w-[90vw] h-[27vh]    overflow-hidden shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px] mx-auto">
                ...
                <div className="details w-[90vw] mx-auto items-center h-[40vh]">
                    ...
                    <div className="tech w-[44vw] mx-auto justify-center font-xl gap-x-8 items-center mt-4 h-[10vh] flex flex-row">
                        <img src='https://img.icons8.com/officel/1x/react.png' className='w-10 h-10 rounded-md my-4' ></img>
                        <img src='https://img.icons8.com/color/256/css3.png' className='w-10 h-10 rounded-md my-4' ></img>
                    </div>
                </div>
                <div className="code flex flex-row w-[75vw] mx-auto  mt-[10vh] h-[10vh] gap-x-14">
                    <div className='w-[30vw] h-16 mx-auto rounded-xl flex flex-row items-center'>
